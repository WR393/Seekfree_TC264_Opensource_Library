...
#define IMU660RC_ACC_SAMPLE_DEFAULT     ( IMU660RC_ACC_SAMPLE_SGN_2G )          // 在这设置默认的 加速度计 初始化量程
#define IMU660RC_GYRO_SAMPLE_DEFAULT    ( IMU660RC_GYRO_SAMPLE_SGN_250DPS )    // 在这设置默认的 陀螺仪   初始化量程
